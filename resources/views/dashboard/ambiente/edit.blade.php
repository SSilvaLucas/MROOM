...
<div class="container secao-dashboard">
    ...
    <div class="form-config">
      <form class="form" method="post" action="{{route('ambientes.update', $ambienteEd->id)}}" enctype="multipart/form-data">
        <fieldset>
          <legend class="legend">Alterar ambiente {{$ambienteEd->nome}}</legend>
          ...
          <div class="form-group">
              ...
              <input name="nome" type="text" maxlength="30" class="form-control" placeholder="Nome do ambiente" required value="{{$ambienteEd->nome}}">
          </div>
          <div class="form-2-linha-control">
            ...
            <div class="form-2-caracter form-group">
                ...
                <input id="capacidade" name="capacidade" type="number" maxlength="30" class="form-control" placeholder="Capacidade" required value="{{$ambienteEd->capacidade}}">
            </div>
          </div>
          <div class="form-2-linha-control">
          ...
          <div class="form-group">
              ...
              <textarea placeholder="Máximo de 200 Caracteres." name="descricao" class="form-control" maxlength="200" rows="4" cols="50" required>{{$ambienteEd->descricao}}</textarea>
          </div>
